    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=99.9, max_digits=7, verbose_name='Цена')),
                ('image', models.ImageField(default='products/products/default.png,', upload_to='images/products/%Y/%m/%d', verbose_name='Изображение')),
